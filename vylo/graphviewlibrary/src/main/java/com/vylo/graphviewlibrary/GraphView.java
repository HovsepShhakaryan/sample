package com.vylo.graphviewlibrary;
...
public class GraphView extends HorizontalScrollView {
    ...
    private double graphXOffset = 0.95;//X position to start plotting
    ...
    private int markerColor = Color.argb(0, 30, 30, 30);
    ...
    public GraphSurfaceView getFrame() {
    ...
    private void init(Context context) {
        ...
        frame.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, Gravity.LEFT));
        frame.requestLayout();
        this.addView(frame);
    }
    ...
    private class GraphSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
        ...
        private void processAmplitude() {
            ...
            */
            for (int i = listSize - 1; -waveLength <= x; x = x - waveLength) {
                if (i >= 0) {
                    if (i == 0) {
        ...
        public Bitmap savebit(Canvas canvas){
