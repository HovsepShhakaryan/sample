package com.vylo.main.settingsprivacy.presentation.fragment.emailsettings.presentation.fragment
...
import com.vylo.main.databinding.FragmentEmailSettingsBinding

class EmailSettingsFragment : BaseFragment<FragmentEmailSettingsBinding>() {

    override fun getViewBinding() = FragmentEmailSettingsBinding.inflate(layoutInflater)
    ...
    private fun createToolbar() {
        viewBinder.toolbar.apply {
            ...
            setTitle(resources.getString(R.string.email_settings))
    ...
    private fun createContentOfView() {
        viewBinder.updatesText.initialize(
            DrawableTextItem(
                startText = resources.getString(R.string.updates_on_vylo),
                isSwitch = false,
