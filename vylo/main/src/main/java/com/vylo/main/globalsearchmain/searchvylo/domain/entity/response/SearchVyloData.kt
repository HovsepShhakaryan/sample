package com.vylo.globalsearch.searchvylo.domain.entity.response
...
@Parcelize
data class SearchVyloData(
    @SerializedName("next")
    val next: String? = null,
    @SerializedName("previous")
    val previous: String? = null,
    @SerializedName("results")
    val results: List<SearchVyloItem>? = null,
) : Parcelable

@Parcelize
data class SearchVyloItem(
    @SerializedName("id")
    val id: Long? = null,
    ...
    val responseCounter: String? = null,
...
data class ResponseTo(
    ...
    val thumbnailUrl: String? = null,
    @SerializedName("publisher_is_approved")
    val publisherIsApproved: String? = null
) : Parcelable